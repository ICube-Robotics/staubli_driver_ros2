...
#ifndef STAUBLI_ROBOT_DRIVER__COMMUNICATION__UDP_SOCKET_HPP_
#define STAUBLI_ROBOT_DRIVER__COMMUNICATION__UDP_SOCKET_HPP_
...
/**
 * @brief Class for handling bidirectional UDP communication
 */
...
private:
    std::unique_ptr<UDPSocketImpl> impl_;  // Implementation
};

/**
 * @brief Factory implementation for UDP communication
 */
class UDPSocketFactory {
public:
    /**
     * @brief Create a UDP communication interface
     * @return Shared pointer to UDP socket
     */
...
#endif  // STAUBLI_ROBOT_DRIVER__COMMUNICATION__UDP_SOCKET_HPP_
